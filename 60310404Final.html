...
<body>
    <figure class="highcharts-figure">
        ...
        <p class="highcharts-description">
            เรียนสนุกดีครับได้ลองทำอะไรไหม่ๆเกี่ยวกับเทคโนโลยีเยอะดีครับเช่นตัดต่อคลิปวีดีโอก็สนุกดีครับได้เพิ่มทักษะชีวิต
        </p>
    </figure>
    ...
    <script>
        ...
        title: {
            text: 'นาย ณัฐวุฒิ คำเสียง'
        },

        subtitle: {
            text: 'รหัสนิสิต 60310404'
        },
